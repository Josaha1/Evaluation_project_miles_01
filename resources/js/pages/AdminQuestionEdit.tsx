                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 glass-card rounded-2xl p-6">
                            ...
                            {data.type !== 'open_text' && (
                                <div className="space-y-3">
                                    ...
                                    {(data.type === 'rating'
                                        ? [...data.options].sort((a: any, b: any) => (b.score ?? 0) - (a.score ?? 0))
                                        : data.options
                                    ).map((opt: any, displayIdx: number) => {
                                            ...
                                            >
                                                ...
                                                {data.options.length > 1 && (
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            const newOpts = data.options.filter((_: any, idx: number) => idx !== actualIdx)
                                                            setData('options', newOpts)
                                                        }}
