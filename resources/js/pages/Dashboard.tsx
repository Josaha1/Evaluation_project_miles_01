...
const angleLabels: Record<string, string> = {
    top: "🧑‍💼 ประเมินองศาบนของ",
    bottom: "👨‍🎓 ประเมินองศาล่างของ",
    left: "🤝 ประเมินองศาซ้ายของ",
    right: "🔗 ประเมินองศาขวาของ",
};
            ...
            <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {(evaluations?.self ?? []).map((item) =>
                            renderCard(item, true)
                        )}
                    </div>
                </div>

                {/* ประเมินผู้ถูกมอบหมายตามองศา */}
                {Object.entries(groupByAngle).map(([angle, list]) => (
                    <div key={angle}>
                        <h2 className="text-xl font-semibold text-indigo-700 mb-3">
                            {angleLabels[angle] ?? "อื่น ๆ"}
                        </h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
